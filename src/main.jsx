...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main className="main-content">
      ...
      {active === 'result' && <ResultsView scores={scores} average={average} goal={goal} weakestCategory={categories[scores.indexOf(Math.min(...scores))]} onRetake={retakeDiagnosis} onOpenAuth={openAuth} />}
